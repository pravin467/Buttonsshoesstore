...
import com.example.buttonsshoesstoreapp.Model.Cart;
import com.example.buttonsshoesstoreapp.ViewHolder.CartViewHolder;
                    ...
                    public void onClick(View view)
                    {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                if (i == 0)
                                {
                                    Intent intent = new Intent(CartActivity.this, ProdutcsDetails.class);
